...
### This is version 0.9.2. It brings improvements to
...
All of the application code is contained in 4 folders.
...
The applicationframework creates a **home** screen at **frontend/gui/screens/home/** as the landing screen. The developer can use the home screen or add a new screen and then change the landing screen in the ./FyneApp.toml file. After the ./FyneApp.toml file is edited, the developer can update the applicationto the new screen and remove the home screen.
...
1. ./ which contains main.go, screens.go and FyneApp.toml
...
BUILDING THE APP:
You can build the applicationafter running the command `＄ kickfyne framework`.
