...
Version 0.7.1 adds some code missing from the 0.7.0 upgrade.
Version 0.7.0 brings changes to the folder layout of the framework.
Version 0.6.0 brought documentation improvments from version 0.5.?

I think kickfyne provides all of the work that I want done. I still need to remove some unnecessary front-end widgets.
