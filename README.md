...
This is version 0.4.01 which removes complexities and restrictions allowing me to do anything with the front-end. The more that I use kickfyne, the more that I change it so that I can do more.

So at this point I'm going to build another app and make the changes I want to make to kickfyne while doing that. I know there's some documentation I want to change.
