...
### This is version 0.9.0. It brings improvements to
...
1. An optional applicationicon.
1. A system tray menu
1. An applicationmenu.
1. A landing screen.
1. Any other screens a developer wants to add with kickfyne.
1. At startup, the applicatioinlication window opens almost immediately and before the panels in the screens might have completed filling with dynamic content.
