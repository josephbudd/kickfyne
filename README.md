...
This is version 0.4.0 which removes complexities and restrictions allowing me to do anything with the front-end. The more that I use kickfyne, the more that I change it so that I can do more.
