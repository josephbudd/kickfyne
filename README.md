...
### The front-end's GUI has some of what you would expect in a fyne app

1. An optional app icon.
...
The app framework creates a **home** screen at **frontend/gui/screens/home/** as the landing screen. The developer can use the home screen or add a new screen and then change the landing screen in the ./FyneApp.toml file. After the ./FyneApp.toml file is edited, the developer can update the app to the new screen and remove the home screen.
